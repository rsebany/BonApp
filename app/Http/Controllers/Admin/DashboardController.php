...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $weeklyRevenue = FoodOrder::select(
        ...
        // Monthly orders data
        $monthlyOrders = FoodOrder::select(
                DB::raw('DATE(created_at) as date'),
        ...
        $orderStatusDistribution = FoodOrder::select(
        ...
        $topRestaurants = Restaurant::select(
                'restaurants.id',
        ...
        // Recent orders
        $recentOrders = FoodOrder::with(['customer:id,first_name,last_name', 'restaurant:id,restaurant_name', 'orderStatus:id,status_value'])
